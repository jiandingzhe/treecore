...
template< typename T >\
static T exchange( volatile T& objToExchange , BestParam<T>::type exchangeValue , ENABLE_IF_SIZE_IS(Number) ) noexcept\
{\
...
template< typename T >\
static void set( volatile T& objToSet , BestParam<T>::type newValue , ENABLE_IF_SIZE_IS(Number) ) noexcept\
{\
    __InterlockedExchange##Number( CASTPTR( objToSet , Number ) , CAST( newValue , Number ) );\
};\
template< typename T >\
static T compareAndSwapReturnOldValue( volatile T& objToCAS , BestParam<T>::type compareValue , BestParam<T>::type newValue , ENABLE_IF_SIZE_IS(Number) ) noexcept\
{\
    RETURN(Number, __InterlockedCompareExchange##Number( CASTPTR( objToCAS , Number ) , CAST( compareValue , Number ) , CAST( newValue , Number ) ) );\
}\
template< typename T >\
static bool compareAndSwap( volatile T& objToCAS , BestParam<T>::type compareValue , BestParam<T>::type newValue , ENABLE_IF_SIZE_IS(Number) ) noexcept\
{\
...
template< typename T >\
static bool compareAndSwapFetchCompareValue( volatile T& objToCAS , T& compareValue , BestParam<T>::type newValue , ENABLE_IF_SIZE_IS(Number) ) noexcept\
{\
