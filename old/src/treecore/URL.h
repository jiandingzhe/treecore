...
public:
    ...
    */
    ...
    /** Returns a copy of this URL, with a set of GET or POST parameters added.
        ...
        @see withParameter
    */
    URL withParameters (const HashMap<String, String>& parametersToAdd) const;
    ...
    */
    ...
    InputStream* createInputStream (bool usePostCommand,
                                    ...
                                    HashMap<String, String>* responseHeaders = nullptr,
...
private:
    ...
    struct Upload  : public RefCountObject
    {
        ...
        TREECORE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Upload)
    };

    friend struct ContainerDeletePolicy<Upload>;
    Array<RefCountHolder<Upload>> filesToUpload;
