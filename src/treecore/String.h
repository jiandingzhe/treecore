...
#ifndef TREECORE_STRING_H
#define TREECORE_STRING_H

#include "treecore/MathsFunctions.h"

#include "treecore/Memory.h"
#include "treecore/CharPointer_ASCII.h"
...
static_assert( sizeof(wchar_t) == 1, "wide char is 1 byte" );
#elif TREECORE_NATIVE_WCHAR_IS_UTF16
typedef CharPointer_UTF16 CharPointer_wchar_t;
static_assert( sizeof(wchar_t) == 2, "wide char is 2 byte" );
#elif TREECORE_NATIVE_WCHAR_IS_UTF32
typedef CharPointer_UTF32 CharPointer_wchar_t;
static_assert( sizeof(wchar_t) == 4, "wide char is 4 byte" );
#else
#    error invalid native wide char determination
#endif
...
/// \see StringArray
///
class TREECORE_SHARED_API String
{
public:
    //==============================================================================
    ...
    static String charToString( treecore_wchar character );
...
#    error do not know how to determine string storage type
    ...
    /** Appends a character at the end of this string. */
    String& operator += ( treecore_wchar characterToAppend );
   #endif
    ...
    /** Tests whether the string begins with a particular character.
        ...
        Uses a case-sensitive comparison.
     */
    bool startsWithChar( treecore_wchar character ) const noexcept;
    ...
    /** Tests whether the string ends with a particular character.
        ...
        Uses a case-sensitive comparison.
     */
    bool endsWithChar( treecore_wchar character ) const noexcept;
    ...
    /** Tests whether the string contains a particular character.
        Uses a case-sensitive comparison.
     */
    bool containsChar( treecore_wchar character ) const noexcept;
     ...
     */
    int indexOfChar( treecore_wchar characterToLookFor ) const noexcept;
    ...
    /** Searches for a character inside this string.
        ...
        @returns            the index of the first occurrence of the character in this
                            string, or -1 if it's not found.
     */
    int indexOfChar( int startIndex, treecore_wchar characterToLookFor ) const noexcept;
     ...
     */
    int lastIndexOfChar( treecore_wchar character ) const noexcept;
    ...
    /** Returns the character at this index in the string.
        ...
        @see getCharPointer
     */
    treecore_wchar operator [] ( int index ) const noexcept;

    /** Returns the final character of the string.
        If the string is empty this will return 0.
     */
    treecore_wchar getLastCharacter() const noexcept;
    ...
    String replaceCharacter( treecore_wchar characterToReplace,
                             treecore_wchar characterToInsertInstead ) const;
     ...
     */
    String quoted( treecore_wchar quoteCharacter = '"' ) const;
     ...
     */
    String paddedLeft( treecore_wchar padCharacter, int minimumLength ) const;

    /** Returns a copy of this string with the specified character repeatedly added to its
        end until the total length is at least the minimum length specified.
     */
    String paddedRight( treecore_wchar padCharacter, int minimumLength ) const;
...
TREECORE_SHARED_API String TREECORE_STDCALL operator + ( const char* string1,     const String& string2 );
/** Concatenates two strings. */
TREECORE_SHARED_API String TREECORE_STDCALL operator + ( const wchar_t* string1,  const String& string2 );
/** Concatenates two strings. */
TREECORE_SHARED_API String TREECORE_STDCALL operator + ( char string1,            const String& string2 );
/** Concatenates two strings. */
TREECORE_SHARED_API String TREECORE_STDCALL operator + ( wchar_t string1,         const String& string2 );
#if !TREECORE_NATIVE_WCHAR_IS_UTF32
/** Concatenates two strings. */
TREECORE_SHARED_API String TREECORE_STDCALL operator + ( treecore_wchar string1,      const String& string2 );
#endif

/** Concatenates two strings. */
TREECORE_SHARED_API String TREECORE_STDCALL operator + ( String string1, const String& string2 );
/** Concatenates two strings. */
TREECORE_SHARED_API String TREECORE_STDCALL operator + ( String string1, const char* string2 );
/** Concatenates two strings. */
TREECORE_SHARED_API String TREECORE_STDCALL operator + ( String string1, const wchar_t* string2 );
/** Concatenates two strings. */
TREECORE_SHARED_API String TREECORE_STDCALL operator + ( String string1, char characterToAppend );
/** Concatenates two strings. */
TREECORE_SHARED_API String TREECORE_STDCALL operator + ( String string1, wchar_t characterToAppend );
#if !TREECORE_NATIVE_WCHAR_IS_UTF32
/** Concatenates two strings. */
TREECORE_SHARED_API String TREECORE_STDCALL operator + ( String string1, treecore_wchar characterToAppend );
#endif
...
TREECORE_SHARED_API String& TREECORE_STDCALL operator << ( String& string1, short number );
/** Appends a decimal number at the end of a string. */
TREECORE_SHARED_API String& TREECORE_STDCALL operator << ( String& string1, int number );
/** Appends a decimal number at the end of a string. */
TREECORE_SHARED_API String& TREECORE_STDCALL operator << ( String& string1, long number );
/** Appends a decimal number at the end of a string. */
TREECORE_SHARED_API String& TREECORE_STDCALL operator << ( String& string1, int64 number );
/** Appends a decimal number at the end of a string. */
TREECORE_SHARED_API String& TREECORE_STDCALL operator << ( String& string1, uint64 number );
/** Appends a decimal number at the end of a string. */
TREECORE_SHARED_API String& TREECORE_STDCALL operator << ( String& string1, float number );
/** Appends a decimal number at the end of a string. */
TREECORE_SHARED_API String& TREECORE_STDCALL operator << ( String& string1, double number );

//==============================================================================
/** Case-sensitive comparison of two strings. */
TREECORE_SHARED_API bool TREECORE_STDCALL operator == ( const String& string1, const String& string2 ) noexcept;
/** Case-sensitive comparison of two strings. */
TREECORE_SHARED_API bool TREECORE_STDCALL operator == ( const String& string1, const char* string2 ) noexcept;
/** Case-sensitive comparison of two strings. */
TREECORE_SHARED_API bool TREECORE_STDCALL operator == ( const String& string1, const wchar_t* string2 ) noexcept;
/** Case-sensitive comparison of two strings. */
TREECORE_SHARED_API bool TREECORE_STDCALL operator == ( const String& string1, const CharPointer_UTF8 string2 ) noexcept;
/** Case-sensitive comparison of two strings. */
TREECORE_SHARED_API bool TREECORE_STDCALL operator == ( const String& string1, const CharPointer_UTF16 string2 ) noexcept;
/** Case-sensitive comparison of two strings. */
TREECORE_SHARED_API bool TREECORE_STDCALL operator == ( const String& string1, const CharPointer_UTF32 string2 ) noexcept;
...
//==============================================================================
/** This operator allows you to write a treecore String directly to std output streams.
    This is handy for writing strings to std::cout, std::cerr, etc.
 */
template<class traits>
std::basic_ostream<char, traits>& TREECORE_STDCALL operator << ( std::basic_ostream<char, traits>& stream, const String& stringToWrite )
{
 ...
 */
template<class traits>
std::basic_ostream<wchar_t, traits>& TREECORE_STDCALL operator << ( std::basic_ostream<wchar_t, traits>& stream, const String& stringToWrite )
{
    return stream << stringToWrite.toWideCharPointer();
}

/** Writes a string to an OutputStream as UTF8. */
TREECORE_SHARED_API OutputStream& TREECORE_STDCALL operator << ( OutputStream& stream, const String& stringToWrite );

/** Writes a string to an OutputStream as UTF8. */
TREECORE_SHARED_API OutputStream& TREECORE_STDCALL operator << ( OutputStream& stream, StringRef stringToWrite );

}

#endif // TREECORE_STRING_H
