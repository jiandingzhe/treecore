...
#if defined TREECORE_OS_ANDROID && ! defined (JUCE_DISABLE_JUCE_VERSION_PRINTING)
...
String SystemStats::getStackBacktrace()
{
   ...
   #if defined TREECORE_OS_ANDROID || (defined TREECORE_OS_WINDOWS && defined TREECORE_COMPILER_GCC)
