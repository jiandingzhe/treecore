...
//==============================================================================
#ifdef TREECORE_DLL_BUILD
TREECORE_SHARED_API void* _dll_malloc_( size_t sz )    { return std::malloc( sz ); }
TREECORE_SHARED_API void  _dll_free_( void* block )    { std::free( block ); }
#endif
...
SystemStats::OperatingSystemType SystemStats::getOperatingSystemType()
{
    ...
    treecore_assert_false;  // need to support whatever new version is running!
    return UnknownOS;
}
...
String SystemStats::getOperatingSystemName()
{
    ...
    default:                treecore_assert_false; break;     // !! new type of OS?
    }
...
public:
        ...
        : hiResTicksOffset( 0 )
    {
        ...
        // always been the value used in apps, and changing it could
        ...
        // function.
#ifndef TREECORE_WIN32_TIMER_PERIOD
#    define TREECORE_WIN32_TIMER_PERIOD 1
#endif
    ...
    inline int64 getHighResolutionTicks() noexcept
    {
        ...
        const int64 mainCounterAsHiResTicks = (_milli_seconds_since_startup_() * hiResTicksPerSecond) / 1000;
...
//==============================================================================
static int64 _get_clock_cycle_counter_() noexcept
{
#if TREECORE_MSVC_INTRIN
...
{
    const int64 cycles  = _get_clock_cycle_counter_();
    ...
    for (;; )
    {
        ...
        const int64 cyclesNow = _get_clock_cycle_counter_();
...
String SystemStats::getDisplayLanguage()
{
    ...
    TREECORE_LOAD_WINAPI_FUNCTION( dll, GetUserDefaultUILanguage, getUserDefaultUILanguage, LANGID, (void) )
