...
#include "treecore/native/win32_ComSmartPtr.h"
...
//==============================================================================
File TREECORE_STDCALL File::getSpecialLocation( const SpecialLocationType type )
{
    int csidlType = 0;
...
void File::revealToUser() const
{
    ...
    TREECORE_LOAD_WINAPI_FUNCTION( dll,          ILCreateFromPathW, ilCreateFromPathW,          ITEMIDLIST*, (LPCWSTR) )
    TREECORE_LOAD_WINAPI_FUNCTION( dll,                     ILFree, ilFree,                     void,        (ITEMIDLIST*) )
    TREECORE_LOAD_WINAPI_FUNCTION( dll, SHOpenFolderAndSelectItems, shOpenFolderAndSelectItems, HRESULT,     (ITEMIDLIST*, UINT, void*, DWORD) )
