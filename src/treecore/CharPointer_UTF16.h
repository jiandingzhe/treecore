...
#ifndef TREECORE_CHARPOINTER_UTF16_H
#define TREECORE_CHARPOINTER_UTF16_H
...
{
public:
#if TREECORE_NATIVE_WCHAR_IS_UTF16
    ...
    treecore_wchar operator * () const noexcept
    {
    ...
    treecore_wchar getAndAdvance() noexcept
    {
        uint32 n = (uint32) (uint16) * data++;
    ...
    treecore_wchar operator [] ( const int characterIndex ) const noexcept
    {
    ...
    void write( treecore_wchar charToWrite ) noexcept
    {
     ...
     */
    static size_t getBytesRequiredFor( const treecore_wchar charToWrite ) noexcept
    {
    ...
    treecore_wchar toUpperCase() const noexcept { return CharacterFunctions::toUpperCase( operator * () ); }
    /** Returns a lower-case version of the first character of this string. */
    treecore_wchar toLowerCase() const noexcept { return CharacterFunctions::toLowerCase( operator * () ); }
    ...
    {
        CharType* prev = treecore::atomic_exchange( &data, newValue.data );
    ...
    {
        treecore_assert( possibleByteOrder != nullptr );
...
#endif   // TREECORE_CHARPOINTER_UTF16_H
