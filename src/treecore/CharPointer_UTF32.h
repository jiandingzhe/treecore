...
#ifndef TREECORE_CHARPOINTER_UTF32_H
#define TREECORE_CHARPOINTER_UTF32_H
...
{
public:
    typedef treecore_wchar CharType;
    ...
    inline treecore_wchar operator * () const noexcept        { return *data; }
    ...
    inline treecore_wchar getAndAdvance() noexcept  { return *data++; }
    ...
    {
#if TREECORE_NATIVE_WCHAR_IS_UTF32 && !TREECORE_OS_ANDROID
        return wcslen( data );
#else
        size_t n = 0;
        while (data[n] != 0)
    ...
    treecore_wchar toUpperCase() const noexcept { return CharacterFunctions::toUpperCase( *data ); }
    /** Returns a lower-case version of the first character of this string. */
    treecore_wchar toLowerCase() const noexcept { return CharacterFunctions::toLowerCase( *data ); }
...
#endif   // TREECORE_CHARPOINTER_UTF32_H
