...
#ifndef TREECORE_SUBREGIONSTREAM_H
#define TREECORE_SUBREGIONSTREAM_H
...
private:
    ...
    TREECORE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SubregionStream)
};

}

#endif   // TREECORE_SUBREGIONSTREAM_H
