...
{
   #if defined TREEJUCE_CPU_X86 && ! JUCE_NO_INLINE_ASM
...
void CPUInformation::initialise() noexcept
{
   ...
   #if defined TREEJUCE_OS_IOS || (MAC_OS_X_VERSION_MIN_REQUIRED >= MAC_OS_X_VERSION_10_5)
