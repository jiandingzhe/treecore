...
#if defined TREEJUCE_COMPILER_MSVC && ! defined (DOXYGEN)  // The MSVC libraries omit these functions for some reason...
...
//==============================================================================
#if (defined TREEJUCE_CPU_X86 && TREEJUCE_SIZE_PTR == 4) || defined (DOXYGEN)
