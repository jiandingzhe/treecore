...
//==============================================================================
#if defined TREEJUCE_OS_IOS || defined TREEJUCE_OS_LINUX || defined TREEJUCE_OS_ANDROID || defined TREEJUCE_CPU_PPC
  ...
  */
  ...
  #ifndef TREEJUCE_COMPILER_ICC
    #pragma intrinsic (__debugbreak)
  #endif
  #define juce_breakDebugger        { __debugbreak(); }
#elif defined TREEJUCE_COMPILER_GCC || defined TREEJUCE_OS_OSX
...
#if defined TREEJUCE_COMPILER_CLANG && defined (__has_feature) && ! defined (JUCE_ANALYZER_NORETURN)
...
#if defined TREEJUCE_COMPILER_MSVC || DOXYGEN
...
#elif defined TREEJUCE_COMPILER_MSVC && ! JUCE_NO_DEPRECATION_WARNINGS
...
#elif defined TREEJUCE_COMPILER_GCC && ! JUCE_NO_DEPRECATION_WARNINGS
...
//==============================================================================
#if defined TREEJUCE_OS_ANDROID && ! DOXYGEN
