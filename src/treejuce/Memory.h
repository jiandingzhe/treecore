...
//==============================================================================
#if defined TREEJUCE_OS_OSX || defined TREEJUCE_OS_IOS || DOXYGEN
...
*/
#if defined TREEJUCE_COMPILER_MSVC && (defined (JUCE_DLL) || defined (JUCE_DLL_BUILD)) && ! (JUCE_DISABLE_DLL_ALLOCATORS || DOXYGEN)
