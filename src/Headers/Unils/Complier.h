...
#include "Headers/Unils/DefaultUserFlags.h"

/**********************************************************************
查找编译器类型,TREECORE支持的编译器共有以下几种:
TREE_COMPILER_GCC : GCC
TREE_COMPILER_MSVC : 微软C++编译器
TREE_COMPILER_MINGW : minGW的编译器
TREE_COMPILER_INTEL_ICC : Intel ICC编译器
TREE_COMPILER_CLANG : Clang编译器
TREE_COMPILER_DOXYGEN : DOXYGEN的解析器

请注意这些编译器宏并非是排它的,
其中,Clang编译器,minGW的编译器和ICC编译器要依托GCC或MSVC编译器,
因此有可能同时有多个编译器宏被指定,例如,在windows平台下使用
ICC编译器,则TREE_COMPILER_MSVC和TREE_COMPILER_INTEL_ICC两个宏
会同时被定义(因为ICC在windows下依赖vc编译器),而在mac下使用clang编译器
也会导致TREE_COMPILER_GCC和TREE_COMPILER_CLANG同时被定义.

这样做的目的是,例如clang在大多数情况下行为和GCC很像,GCC支持的一些特殊特性
clang也支持,因此大部分情况下clang还是和GCC共享同样的代码,而如果真的遇到clang
的特殊代码,则直接使用#if TREE_COMPILER_CLANG 即可. ICC,minGW也是类似的情况.
...
例如隐藏某个私有类,去掉一些不必要的标示.TREE_COMPILER_DOXYGEN这个宏
存在的意义主要在此.
...
************************************************************************/
#if defined( __GNUC__ )
#   define TREE_COMPILER_GCC 1
#elif defined( _MSC_VER )
#   define TREE_COMPILER_MSVC 1
#elif defined( DOXYGEN )
#   define TREE_COMPILER_DOXYGEN 1
#else
#   error unsupported compiler
#endif

#if defined( __MINGW32__ ) || defined( __MINGW64__ )
#   define TREE_COMPILER_MINGW 1
#endif

#if defined( __ICC ) || defined( __ICL ) || defined( __INTEL_COMPILER )
#   define TREE_COMPILER_INTEL_ICC 1
#endif

#ifdef __clang__
#   define TREE_COMPILER_CLANG 1
#endif

#ifndef TREE_COMPILER_GCC
#   define TREE_COMPILER_GCC 0
#endif
#ifndef TREE_COMPILER_MSVC
#   define TREE_COMPILER_MSVC 0
#endif
#ifndef TREE_COMPILER_DOXYGEN
#   define TREE_COMPILER_DOXYGEN 0
#endif
#ifndef TREE_COMPILER_MINGW
#   define TREE_COMPILER_MINGW 0
#endif
#ifndef TREE_COMPILER_INTEL_ICC
#   define TREE_COMPILER_INTEL_ICC 0
#endif
#ifndef TREE_COMPILER_CLANG
#   define TREE_COMPILER_CLANG 0
#endif
...
**********************************************************************/
#if TREE_COMPILER_MSVC && !TREE_COMPILER_INTEL_ICC
#   if _MSC_VER < 1900 //VS 2015
#       define TREE_COMPILER_NOT_GOOD
#   endif
#endif

#if TREE_COMPILER_GCC && !TREE_COMPILER_CLANG
#   if ( __GNUC__ * 100 + __GNUC_MINOR__ ) < 308
#       define TREE_COMPILER_NOT_GOOD
#   endif
#endif

#if TREE_COMPILER_CLANG
...
#ifdef TREE_COMPILER_NOT_GOOD
#   undef TREE_COMPILER_NOT_GOOD
